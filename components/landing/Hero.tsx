      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 items-center">
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                className="w-full sm:w-auto px-8 py-4 rounded-full bg-[#101828] text-white font-bold text-lg shadow-xl hover:shadow-2xl transition-shadow"
              >
              ...
              <button className="flex items-center gap-2 px-6 py-4 text-[#101828] font-bold hover:text-teal transition-colors">
                <div className="w-10 h-10 rounded-full bg-white border border-gray-100 shadow-md flex items-center justify-center">
                  <Play className="w-4 h-4 fill-teal" />
                </div>
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="relative aspect-video rounded-3xl overflow-hidden shadow-2xl border-4 border-white group hover:scale-[1.01] transition-transform cursor-pointer">
              ...
              <div className="absolute inset-0 flex items-center justify-center z-10">
                <div className="w-20 h-20 rounded-full bg-white/90 backdrop-blur shadow-2xl flex items-center justify-center group-hover:scale-110 transition-transform">
                  <Play className="w-8 h-8 fill-[#101828] ml-1" />
                </div>
              </div>
              <img
            ...
            <motion.div
              ...
              className="absolute -top-6 -right-6 lg:-right-12 bg-white dark:bg-[#101828] p-4 rounded-2xl shadow-2xl border border-gray-100 hidden md:block"
            >
