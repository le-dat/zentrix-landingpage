...
> *"Connected my broker and the rebates just showed up automatically. Withdrawal was fast, fees were clear. No need to ask anyone anything."*
...
### Disclaimer *(full width, small muted text)*
...
2. `LP-03` How It Works — product explanation
...
*Zentrix internal document · Update on scope changes · v1.0 / 04-2026*