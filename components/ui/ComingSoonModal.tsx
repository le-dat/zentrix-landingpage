        ...
        <div className="rounded-2xl md:rounded-3xl bg-black/90 border border-white/10 overflow-hidden shadow-2xl">
          ...
          <div className="relative px-4 py-5 md:px-8 md:py-6 lg:p-10 flex flex-col items-center text-center">
            ...
            <button
              type="button"
              onClick={onClose}
              className="absolute top-2.5 right-2.5 md:top-4 md:right-4 p-1.5 md:p-2 rounded-full text-white/50 hover:text-white hover:bg-white/10 hover:cursor-pointer transition-colors"
